import json
from wiki_data_source import get_content,get_medical_title,get_non_medical_title
import os
...
def prepare_data():
    ...
    if os.path.isfile('./src/data/non_medical_title.json')==False:
        _write_to_file(data=get_non_medical_title(number=300),filename='non_medical_title.json')
    if os.path.isfile('./src/data/medical_title.json')==False:
        _write_to_file(data=get_medical_title(number=300),filename='medical_title.json')
